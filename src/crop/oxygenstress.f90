...
! ----------------------------------------------------------------------
! [GR-CROP 2026-05-25] oxygen_dat + OxygenReproFunction extracted to
! src/crop/dormant/oxygenrepro.f90. They implement the swoxygen=2 /
! swoxygentype=2 reproduction-function compute path, whose only
! dispatch site (the `swoxygentype /= 1` branch in
! rootextraction.f90:155) has been a fatalerr_collected stub since
! Task 3 — zero live callers. The dormant file is excluded from
! meson.build; see its header for the reactivation checklist.
! ----------------------------------------------------------------------
