...
| bunsencoeff               | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| c_macro                   | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| c_min_micro               | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| c_mroot                   | oxygenstress                             | 1 | B | state%cfg% (direct read)            | cross=N |
| c_top                     | oxygenstress                             | 1 | B | state%cfg% (direct read)            | cross=N |
...
| ctopnode                  | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| d_o2inwater               | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| d_root                    | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| d_soil                    | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
...
| depth                     | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
...
| gas_filled_porosity       | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
...
| o2_bunsencoeff            | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_c_macro                | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_c_min_micro            | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_capac_term             | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_ctopnode               | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_d_o2inwater            | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_d_root                 | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_d_soil                 | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_d_soil_term1           | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_d_soil_term2           | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_depth                  | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_gas_filled_porosity    | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_gfp100                 | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_ini_stress             | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_mplus1                 | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_nmin1                  | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_perc_org_mat           | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_r_microbial_z0         | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_root_radius            | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_sat_water_cont         | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_shape_factor_microbialr | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_soil_density           | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_soil_temp              | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_w_root                 | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_w_root_z0              | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| o2_waterfilm_thickness    | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
...
| perc_org_mat              | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
...
| r_microbial_z0            | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
...
| root_radius               | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
...
| sat_water_cont            | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| shape_factor_microbialr   | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
...
| soil_density              | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| soil_temp                 | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
...
| w_root                    | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| w_root_ss                 | oxygenstress, cropfixed_runtime          | 2 | C | state%crop% (new field)             | cross=Y |
| w_root_z0                 | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
| waterfilm_thickness       | oxygenstress                             | 1 | C | state%crop% (new field)             | cross=N |
