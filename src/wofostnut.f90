!   File VersionID:
!   $Id: wofostnut.f90 378 2018-05-08 13:50:52Z heine003 $
! ----------------------------------------------------------------------
!*
...
!
! ----------------------------------------------------------------------
      SUBROUTINE NUTRIE (NLUE,WLV,WST,DVS,                              &
     &                   ANLV,ANST,NMXLV,                               &
...
!     global
!      integer  ILNMXL
      real(8)  NMXLV(30),NLUE                         ! ,TRA,TRAMX
...
!     Nutrient reduction factor     
      FSTR = max(0.0d0, min(1.0d0, (1.d0-NLUE*(1.0001d0-NNI)**2)))
