...
module crop_wofost_state_mod
   ...
   type :: crop_wofost_state_t
      ...
      ! [GR-CROP 2026-05-25] root-growth runtime (from cropgrass/cropwofost runtimes)
      real(real64) :: gwrt    = 0.0_real64   !! daily root growth rate (kg/ha/d)
      real(real64) :: wrtmin  = 0.0_real64   !! minimum root weight at relative depth (kg/ha)
